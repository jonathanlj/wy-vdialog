<template>
    <button v-if="enabled" :class="['dg-btn', 'dg-btn--ok', {'dg-btn--loading': loading}, {'dg-pull-right': !options.reverse}, {'dg-btn--ok-lef': !options.reverse && options.window === 'confirm'}, {'lef-1px': !options.reverse && options.window === 'confirm'}, {'dg-btn--ok-rig': options.reverse && options.window === 'confirm'}, {'rig-1px': options.reverse && options.window === 'confirm'}, {'dg-alert-right': options.window === 'alert'}]"
